...
public class Signup3 extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        long first7 = (ran.nextLong() % 900000000000L) + 5040000000000000L;
                ...
                }else if(a==null)
		{
		    ...
		    LocalDateTime now=LocalDateTime.now();
                    ...
                    String q1 = "insert into accountdetails values('"+form_number+"','"+a+"','"+first8+"','"+first4+"','"+b+"','"+Date+"')";  
                    String q2 = "insert into login values('"+first8+"','"+first4+"')";
                    c1.s.executeUpdate(q1);
                    c1.s.executeUpdate(q2);
                    
                    new deposit2(first8+"",first4+"").setVisible(true);
                    setVisible(false);
                }
			...
			jdbcConn c1 = new jdbcConn();
                	String q1 = "delete from AdditionalDetails where formno='"+form_number+"'";
                	c1.s.executeUpdate(q1);

                	String q2 = "delete from PeronsalDetails where formno='"+form_number+"'";
                	c1.s.executeUpdate(q2);
			...
			new Signup2(form_number).setVisible(true);
			setVisible(false);
